...
folder_list = [x for x in folder_list if not ("ORTHOGONAL_NG_matrices" in x[0])]
folder_list = [x for x in folder_list if not ("class_sz_auxiliary_files" in x[0])]
folder_list = [x for x in folder_list if not ("python/classy_szfast/classy_szfast/__pycache__" in x[0])]
folder_list = [x for x in folder_list if not ("python/classy_szfast/classy_szfast.egg-info" in x[0])]
folder_list = [x for x in folder_list if not ("class_sz_mcmcs" in x[0])]
folder_list = [x for x in folder_list if not ("pt_matrices" in x[0])]
folder_list = [x for x in folder_list if not ("python/dist" in x[0])]
folder_list = [x for x in folder_list if not ("notebooks/class_sz_" in x[0])]
folder_list = [x for x in folder_list if not ("include/gsl" in x[0])]
folder_list = [x for x in folder_list if not ("notebooks/.ipynb_checkpoints" in x[0])]
folder_list = [x for x in folder_list if not ("python/classy_sz.egg-info" in x[0])]
folder_list = [x for x in folder_list if not ("notebooks/__pycache__" in x[0])]

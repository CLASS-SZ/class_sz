#! python3
#$ python sz_auxiliary_files/run_scripts/compute_and_plot_snr_figure_rotti++20.py -param_name 'signal-to-noise cut-off for ps completeness analysis' -p_val '[1,3,6,20,50,100]' -spacing log -show_legend yes -show_error_bars no -output 'tSZ_1h,tSZ_2h' -save_tsz_ps no -save_figure yes -plot_redshift_dependent_functions no -plot_ref_data yes
import argparse
import numpy as np
import os
import subprocess

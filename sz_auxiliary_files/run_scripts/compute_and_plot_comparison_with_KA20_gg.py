...
def run(args):
    ...
    cell_gg_2h = hm_ang_power_spectrum(cosmo, ell, (g,g),
                                    zrange=zrange,
                                    include_1h=False,
                                    hm_correction=None,
                                    **m["model"])

    cell_gg_1h = hm_ang_power_spectrum(cosmo, ell, (g,g),
                                    zrange=zrange,
                                    include_2h=False,
                                    include_1h=True,
                                    hm_correction=None,

...
class_sz_ptsz_parameter(szcc_dof,double,0.)
...
class_sz_ptsz_parameter(n_k_pressure_profile_2h,int,100)
class_sz_ptsz_parameter(n_m_pressure_profile,int,30)
class_sz_ptsz_parameter(n_l_pressure_profile,int,300)
...
class_sz_ptsz_parameter(array_b_custom1_n_z,int,1000)
...
class_sz_ptsz_parameter(skip_hubble,int,0)
class_sz_ptsz_parameter(skip_pknl,int,0)
class_sz_ptsz_parameter(skip_pkl,int,0)
class_sz_ptsz_parameter(skip_pk,int,0)
class_sz_ptsz_parameter(want_pp,int,1)
class_sz_ptsz_parameter(skip_class_sz,int,0)
class_sz_ptsz_parameter(do_real_space_with_mcfit,int,0)
class_sz_ptsz_parameter(skip_background_and_thermo,int,0)
...
class_sz_ptsz_parameter(l_max_gas_pressure_profile,double,5e4)
...
// class_sz_ptsz_parameter(has_b_custom1,int,0)

...
int input_read_from_file(struct file_content * pfc,
  ...
  class_call(input_read_precisions(pfc,ppr,pba,pth,ppt,ptr,ppm,psp,pnl,ple,ptsz,pop,
                                   errmsg),
             errmsg,
             errmsg);
  ...
  /** Find out if shooting necessary and, eventually, shoot and initialize
      read parameters */
  class_call(input_shooting(pfc,ppr,pba,pth,ppt,ptr,ppm,psp,pnl,ple,ptsz,pcsz,pop,
                            input_verbose,
                            &has_shooting,
                            errmsg),
             errmsg,
  ...
  if(has_shooting == _FALSE_){
    class_call(input_read_parameters(pfc,ppr,pba,pth,ppt,ptr,ppm,psp,pnl,ple,ptsz,pcsz,pop,
                                     errmsg),
               errmsg,
               errmsg);
  }

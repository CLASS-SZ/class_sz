                        ...
                        struct tszspectrum * ptsz)
{
 ...
 //  // a simplistic scaled nfw profile:
 //
 ...
 //                                   }
 //   else{
 //   // use analytical formula with Sine and Cosine integrals
 ...
 //
 //  double sigmaT_over_mp = 8.30702e-17 * pow(pba->h,2)/pba->h; // !this is sigmaT / m_prot in (Mpc/h)**2/(Msun/h)
                                   ...
                                   struct tszspectrum * ptsz)
{
  ...
  if (ptsz->unwise_galaxy_sample_id==3){
    ...
    if (_gal_gal_2h_ || _gal_lensmag_2h_)
    b = 1.74;
    else if (_gal_lens_2h_)
    //b = 0.8+1.2*z;
    b = 1.56;
                 ...
                 struct tszspectrum * ptsz)
{
   ...
   if (pvectsz[ptsz->index_has_electron_pressure]+
...
int initialise_and_allocate_memory(struct tszspectrum * ptsz){
  ...
  if (ptsz->integrate_wrt_m200m == 1 && ptsz->has_500c == 1)
   ...
   ptsz->index_integral =  ptsz->index_has_200c + 1;
...
for (index_l=0;index_l<ptsz->cib_frequency_list_num;index_l++){
  ...
  ptsz->cl_lens_cib_2h[index_nu][index_l] = 0.;
   ...
   ptsz->index_integrand_id_kSZ_kSZ_gal_2h_first = ptsz->index_integrand_id_kSZ_kSZ_gal_1h_last + 1;
   ...
   ptsz->index_integrand_id_kSZ_kSZ_lensmag_1halo_first =  ptsz->index_integrand_id_kSZ_kSZ_gal_3h_last + 1;
